...
1. Introduction
    ...
    the toolkit's multimedia capabilities. This readme file describes the MIDlets 
...
2. Usage
    ...
    2.4 Pausing Audio Test
        ...
        is paused and no message is displayed on the KToolbar console. 
        ...
        console, you see the warning: An active media (subtype Player) resource was 
