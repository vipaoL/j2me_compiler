...
2. Usage
    ...
    2.1 Browsing Files
        - To run the file browser, you'll need to give the MIDlet appropriate security 
          authorization, if you have not already done so. Choose Edit > Preferences... 
          from the KToolbar menu. Click on the Security tab. Change the Security 
        ...
        - Using the commands in the demonstration, you can view the file or see 
          ...
          View from the menu.
        - The actual files are located in toolkit\appdb\DefaultColorPhone\filesystem, 
    ...
    2.2 The PIM API
        ...
        in the toolkit\appdb\skin\pim directory. See Chapter 10 for more information.
